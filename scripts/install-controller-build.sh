...
# file -- the build tree keeps one beside each shipped one, three to four times
# the size, and a plain cp of the wrong name would ship a symbol table and six
# debug sections into every engine. And a stamp that disagrees with the media stamps
