...
program with fourteen patches of ours applied, and both halves of that sentence
carry obligations.
...
- Patches applied on top, all fourteen of them ours:
...
The fourteen patch files are published, in full, as
`source-patches/mgvf-0002-*.patch` … `mgvf-0017-*.patch` in
...
and the fourteen patches are in the repository named above. Anyone who cannot
...
| file | bytes | sha256 |
| --- | --- | --- |
| `engine-controller-winebus.sys` | 69,632 | `a26e1fb73048e0de44346918f6268edcc0ffb9ebaac2e1c58a41b4f72928da42` |
...
| `engine-controller-built-for.json` | 275 | `7f293d47bc1e698254e384f9325affb0f6f0a3106816fc96b22d95cd9a9092f6` |
